...
public class MenuControllerVR : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    MainScreenCanvas = GameObject.FindWithTag("MainScreenCanvas");
  ...
  public void Update()
  {
    ...
    if (OVRInput.GetDown(OVRInput.RawButton.X ) && GameMenuCanvas.GetComponent<Canvas>().enabled == false)
    {
      ReturnToGame();
      GameMenuCanvas.GetComponent<Canvas>().enabled = true;
    }else if (OVRInput.GetDown(OVRInput.RawButton.X) && GameMenuCanvas.GetComponent<Canvas>().enabled == true)
    {
    ...
    if (OVRInput.GetDown(OVRInput.RawButton.A) && MainScreenCanvas.GetComponent<Canvas>().enabled == false)
    {
      ReturnToGame();
      MainScreenCanvas.GetComponent<Canvas>().enabled = true;
    }
    else if (OVRInput.GetDown(OVRInput.RawButton.A) && MainScreenCanvas.GetComponent<Canvas>().enabled == true)
    {
      MainScreenCanvas.GetComponent<Canvas>().enabled = false;
    }
  ...
  public void ShowVolumeSettingsCanvas()
  {
    ...
    ShowAmbientSettingsCanvas();
    ShowMusicSettingsCanvas();
    ShowVoiceSettingsCanvas();
    ShowFootstepsSettingsCanvas();
  ...
  public void HideMusicVolumeCanvas()
  {
   
    if (MusicSettingsMenuCanvas.GetComponent<Canvas>().enabled)
    {
      MusicSettingsMenuCanvas.GetComponent<Canvas>().enabled = false;
    }
   
  }
  public void HideAmbientVolumeCanvas()
  {

    if (AmbientSettingsMenuCanvas.GetComponent<Canvas>().enabled)
    {
      AmbientSettingsMenuCanvas.GetComponent<Canvas>().enabled = false;
    }

  }
  public void HideVoiceVolumeCanvas()
  {

    if (VoiceSettingsMenuCanvas.GetComponent<Canvas>().enabled)
    {
      VoiceSettingsMenuCanvas.GetComponent<Canvas>().enabled = false;
    }

  }
  public void HideFootstepsVolumeCanvas()
  {

    if (FootstepsSettingsMenuCanvas.GetComponent<Canvas>().enabled)
    {
      FootstepsSettingsMenuCanvas.GetComponent<Canvas>().enabled = false;
    }
