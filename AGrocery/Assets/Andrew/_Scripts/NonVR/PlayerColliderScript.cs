...
public class PlayerColliderScript : MonoBehaviour
{
    ...
    void OnTriggerStay(Collider product)
    {
        if (product.gameObject.tag == "Product1")
        {
            ...
            {
                PlayerMoneyHandler.TotalCost = PlayerMoneyHandler.TotalCost + 1.00m;
        ...
        if (product.gameObject.tag == "Product2")
        {
            ...
            {
                PlayerMoneyHandler.TotalCost = PlayerMoneyHandler.TotalCost + 1.50m;
        ...
        if (product.gameObject.tag == "Product3")
        {
            ...
            {
                PlayerMoneyHandler.TotalCost = PlayerMoneyHandler.TotalCost + 2.00m;
